...
export const metadata: Metadata = {
  ...
  description: 'Pomoc Psychologiczna na Uniwersytecie Ekonomicznym we Wrocławiu.',
  openGraph: {
    title: 'Pomoc Psychologiczna | SSUEW',
    description: 'Pomoc Psychologiczna na Uniwersytecie Ekonomicznym we Wrocławiu.',
    url: 'https://samorzad.ue.wroc.pl/pomoc-psychologiczna',
    type: 'website',
  },
}
    ...
    <main>
      <section className="pt-36 pb-16 bg-gradient-to-br from-ssuew-gray-100 to-white">
        <div className="max-w-[1200px] mx-auto px-6">
          <FadeUp>
            <h1 className="font-display text-display-xl text-ssuew-black mb-4">Pomoc Psychologiczna</h1>
